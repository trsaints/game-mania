import {
	DataServiceDictionary, Genre, Platform, Publisher, Tag
} from '@data/types'
...
import {
	IParserUtils, IStartupUtils, ITypeUtils, ParserUtils, StartupUtils,
	TypeUtils
} from '@src/utils'
import { IRootViewModel } from '@src/view-models/interfaces/IRootViewModel.ts'
import {
	ApiService, GameService, GenreService, IApiService, IDataService,
	IGameService, PlatformService, PublisherService, TagService
} from '@src/services'
...
class RootViewModel implements IRootViewModel {
	constructor() {
		...
		this._gameService      = new GameService(this._parserUtils,
												 this._typeUtils)
